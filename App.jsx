...
const realply3Data = {
    ...
    installExtensionForChrome: <React.Fragment>Install Extension for Chrome</React.Fragment>,
    chrome: "Chrome",
    firefox: "Firefox",
    place1: "Brave",
    edge: "Edge",
    ...
    loremIpsumDolorSi1: "Get notified & respond to lead notifications at a faster rate",
    autoPilotMarketing: "Auto-Pilot Marketing",
    loremIpsumDolorSi2: "Use Automation to allow campaigns and marketing be done on auto-pilot",
    roiTrackingSystem: "ROI Tracking System",
    loremIpsumDolorSi3: "See Charts & Data to visualize lead data in real time. ",
    ...
    loremIpsumDolorSi4: "Our Software allows you to find the people you want to speak with the most & message them directly.",
    ...
    loremIpsumDolorSi5: "Be in a state of organization as you manage the flow of countless leads.",
    ...
    loremIpsumDolorSi6: "We promise a better than 3$ conversion of 1st messages to all prospective prospects.",
